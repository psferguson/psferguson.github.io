...
* Helping lead the creation of `the_monster`, a photometric reference catalog that will be used for commissioning and early operations of LSST.
...
* Developing software for `faro` and `analysis_tools`, which are packages within the Rubin Science Pipelines (RSP) to conduct automated verification and validation of data processed using the RSP.
